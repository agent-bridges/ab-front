...
export default function MobileWorkspace() {
  ...
  const commitRename = async () => {
    ...
    if (name && name !== mobileEntryTitle(renamingEntry)) {
      if (renamingEntry.kind === 'session') await renameSession(renamingEntry.agentId, renamingEntry.session.id, name);
      else updateBoardItem(renamingEntry.item.id, { label: name });
    }
